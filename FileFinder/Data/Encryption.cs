...
namespace FileFinder.Data
{
    ...
    {
        //ENCRYPTION from: https://msdn.microsoft.com/en-us/library/system.security.cryptography.aes.aspx

        private static readonly Aes myAes = Aes.Create();
        ...
        {
            string decrypted = DecryptStringFromBytes_Aes(bytesToDecrypt, myAes.Key, myAes.IV);
            return decrypted;
        }
